...
<head>
    <head>
        ...
        <link href="${APP_PATH}/css/select.css" rel="stylesheet" type="text/css"/>
        <script type="text/javascript" src="${APP_PATH}/js/jquery.js"></script>
        <script type="text/javascript" src="${APP_PATH}/js/jquery.idTabs.min.js"></script>
        <script type="text/javascript" src="${APP_PATH}/js/select-ui.min.js"></script>
...
<div class="formbody">
    ...
    <form action="${APP_PATH}/customer/saveOrUpdate" method="post">
        <ul class="forminfo">
            ...
            <li><label>性别</label>
                <div class="cityleft">
                    <select class="select2" name="cSex">
                        <option value="0" ${dto.customer.cSex eq false?'selected':'' } >
                            男
                        </option>
                        <option value="1" ${dto.customer.cSex eq true?'selected':'' } >
                            女
                        </option>
                    </select>
                </div>
            ...
            <li><label>业务员</label>
                <div class="cityleft">
                    ...
                    <shiro:hasAnyRoles name="业务员,操作员">
                        <label style="color:red">当前业务员:${dto.realName }</label>
                    </shiro:hasAnyRoles>
